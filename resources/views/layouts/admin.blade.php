...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('home') }}">
            ...
            <div class="sidebar-brand-text mx-3">Covid dat <sup>1</sup></div>
        </a>
        ...
        <!-- Nav Item - About -->
        <li class="nav-item {{ (request()->segment(1) == 'moh_areas') ? 'active' : '' }}"> 
            <a class="nav-link" href="{{ url('moh_areas') }}">
                <i class="fas fa-fw fa-hands-helping"></i>
                <span>{{ __('Moh Areas') }}</span>
            </a>
        </li>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <select name="search_patient" id="search_patient" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" ></select>
